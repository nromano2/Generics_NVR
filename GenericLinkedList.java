...
public class GenericLinkedList<T> {
	private GenericNode<T> head; //A generic type node to represent the head of the list
	private GenericNode<T> tail; //A generic type node to represent the tail (end) of the list
